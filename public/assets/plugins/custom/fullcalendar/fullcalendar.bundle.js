...
(function (global, factory) {
    ...
    */
    ...
    var DateProfileGenerator = /** @class */ (function () {
        ...
        ------------------------------------------------------------------------------------------------------------------*/
        // Builds a structure with info abouts what the dates/ranges will be for the "prev" view.
        ...
        // Builds a structure with info abouts what the dates/ranges will be for the "next" view.
        ...
        // Builds a structure with info abouts the "current" range, the range that is
    ...
    */
    ...
    var Calendar = /** @class */ (function () {
        ...
        */
        ...
        // View
        // -----------------------------------------------------------------------------------------------------------------
        // Returns a boolean abouts whether the view is okay to instantiate at some point
        ...
        Calendar.prototype.incrementDate = function (deltaInput) {
            var delta = createDuration(deltaInput);
            if (delta) { // else, warn abouts invalid input?
                this.unselect();
                this.dispatch({
                    type: 'SET_DATE',
...
(function (global, factory) {
    ...
    */
    ...
    var DayGridEventRenderer = /** @class */ (function (_super) {
        ...
        // the segments. Returns object with a bunch of internal data abouts how the render was calculated.
        ...
        function FeaturefulElementDragging(containerEl) {
            ...
            _this.onPointerDown = function (ev) {
                if (!_this.isDragging) { // so new drag doesn't happen while revert animation is going
                    ...
                    // not necessary for touch, besides, browser would complain abouts passiveness.
                    if (!ev.isTouch) {
    ...
    */
    ...
    var UnselectAuto = /** @class */ (function () {
        function UnselectAuto(calendar) {
            ...
            /*
            TODO: better way to know abouts whether there was a selection with the pointer
            */
    ...
    */
    ...
    var TimeGrid = /** @class */ (function (_super) {
        ...
        TimeGrid.prototype.renderSlatRowHtml = function (dateProfile) {
            ...
            var slotDate; // will be on the view's first day, but we only care abouts its time
            var isLabeled;
            var axisHtml;
