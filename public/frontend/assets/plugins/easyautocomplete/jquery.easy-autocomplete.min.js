...
var EasyAutocomplete = function (a) {
    return a.Configuration = function (a) {
        ...
        this.get = function (a) {
            ...
            g(a, b)
        }, b(), c(), !0 === h.loggerEnabled && g(console, a), e(), d()
    }, a
    ...
    return a.ListBuilderService = function (a, b) {
        ...
        this.init = function (b) {
            ...
            for (var b = 0, c = a.length; b < c; b += 1) if (void 0 !== a[b].data && a[b].data instanceof Array && a[b].data.length > 0) return !0;
            return !1
        }
    }, a
}(EasyAutocomplete || {}), EasyAutocomplete = function (a) {
    return a.proccess = function (b, c, d) {
        function e(a, c) {
            var d = [], e = "";
            if (b.get("list").match.enabled) for (var g = 0, h = a.length; g < h; g += 1) e = b.get("getValue")(a[g]), f(e, c) && d.push(a[g]); else d = a;
            return d
        }
    ...
    return a.main = function (b, c) {
        ...
        function e() {
            function a() {
                ...
                o.get("theme") && "" !== o.get("theme") && (c += " eac-" + o.get("theme")), o.get("cssClasses") && "" !== o.get("cssClasses") && (c += " " + o.get("cssClasses")), "" !== q.getTemplateClass() && (c += " " + q.getTemplateClass()), a.addClass(c), t.wrap(a), !0 === o.get("adjustWidth") && b()
            }
                    ...
                    a.on("show.eac", function () {
                        ...
                        for (var h = 0, i = 0, k = c.length; i < k; i += 1) {
                            ...
                            if (0 !== l.length) {
                                ...
                                for (var m = 0, n = l.length; m < n && h < c[i].maxListSize; m += 1) e = $("<li><div class='eac-item'></div></li>"), function () {
        ...
        function g() {
            ...
            function b() {
                t.focusout(function () {
                    ...
                    for (var c = 0, d = v.length; c < d; c += 1) if (a = o.get("getValue")(v[c]), o.get("list").match.caseSensitive || (a = a.toLowerCase()), a === b) return w = c, void j(w)
                })
            }
                ...
                t.off("keyup").keyup(function (a) {
                    ...
                    switch (a.keyCode) {
                        ...
                        case 40:
                            ...
                            break;
                        default:
                            if (a.keyCode > 40 || 8 === a.keyCode || 0 === a.keyCode) {
                                var c = t.val();
                                !0 !== o.get("list").hideOnEmptyPhrase || 8 !== a.keyCode || "" !== c ? o.get("requestDelay") > 0 ? (void 0 !== m && clearTimeout(m), m = setTimeout(function () {
                                    b(c)
            ...
            function d() {
                t.on("keydown", function (a) {
                    if (a = a || window.event, 38 === a.keyCode) return suppressKeypress = !0, !1
                }).keydown(function (a) {
        ...
        var m, n = new a.Constants, o = new a.Configuration(c), p = new a.Logger, q = new a.Template(c.template),
