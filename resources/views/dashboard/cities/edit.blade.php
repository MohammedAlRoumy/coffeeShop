    ...
    <div class="subheader py-2 py-lg-4 subheader-solid" id="kt_subheader">
        <div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
            ...
            <div class="d-flex align-items-center flex-wrap mr-2">
                <!--begin::Title-->
                <h5 class="text-dark font-weight-bold mt-2 mb-2 mr-5">المدن</h5>
                <!--end::Title-->
                <!--begin::Separator-->
                ...
                <div class="d-flex align-items-center" id="kt_subheader_search">
                    <span class="text-dark-50 font-weight-bold" id="kt_subheader_total">إضافة مدينة</span>
                </div>
                <!--end::Search Form-->
            </div>
            <!--end::Info-->
                                ...
                                <div class="row justify-content-center py-8 px-8 py-lg-15 px-lg-10">
                                    <div class="col-xl-12 col-xxl-10">
                                        ...
                                        <form class="form fv-plugins-bootstrap fv-plugins-framework" id="kt_form"
                                              method="post" action="{{route('cities.update',$city->id)}}"
                                                    ...
                                                    <div class="my-5 step" data-wizard-type="step-content"
                                                        ...
                                                        <div class="form-group row fv-plugins-icon-container">
                                                            ...
                                                            <div class="col-xl-9 col-lg-9">
                                                                <select
                                                                    class="form-control form-control-lg form-control-solid @error('country_id') is-invalid @enderror"
                                                                    name="country_id">
                                                                    @foreach ($countries as $country)

                                                                        <option
                                                                            @if($country->id == old('country_id')) selected
                                                        ...
                                                        <div class="form-group row fv-plugins-icon-container">
                                                            ...
                                                            <div class="col-lg-9 col-xl-9">
                                                                <input
                                                                    ...
                                                                    name="name" type="text" value="{{old('name',$city->name)}}">
                                                        ...
                                                        <div class="form-group row">
                                                            ...
                                                            <div class="col-9 col-form-label">
                                                                <div
                                                                    ...
                                                                    <label class="radio radio-success">
                                                                        <input type="radio" name="status" value="0" {{$city->status =='0'?'checked':''}}/>
                                                                        <span></span>
                                                                        غير مفعل
                                                                    </label>
                                                                </div>
