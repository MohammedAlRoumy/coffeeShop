        ...
        <div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
            ...
            <div class="d-flex align-items-center flex-wrap mr-2">
                ...
                <div class="d-flex align-items-center" id="kt_subheader_search">
                    <span class="text-dark-50 font-weight-bold" id="kt_subheader_total">تعديل منتج</span>
                </div>
                <!--end::Search Form-->
            </div>
            <!--end::Info-->
                                ...
                                <div class="row justify-content-center py-8 px-8 py-lg-15 px-lg-10">
                                    <div class="col-xl-12 col-xxl-10">
                                        ...
                                        <form class="form fv-plugins-bootstrap fv-plugins-framework" id="kt_form"
                                              method="post" action="{{route('products.update',$product->id)}}"
                                                    ...
                                                    <div class="my-5 step" data-wizard-type="step-content"
                                                            ...
                                                            <div class="col-xl-9 col-lg-9">
                                                                <select
                                                                    ...
                                                                    @foreach ($categories as $category)
                                                                        ...
                                                                        <option
                                                                            @if($category->id == old('category_id',$product->category->id)) selected
                                                        ...
                                                        <div class="form-group row fv-plugins-icon-container">
                                                            ...
                                                            <div class="col-lg-9 col-xl-9">
                                                                <input
                                                                    ...
                                                                    name="slug" type="text" value="{{old('slug',$product->slug)}}">
                                                                <div class="fv-plugins-message-container">
                                                                    @error('slug')
                                                                    <div class="text-danger">{{ $message }}</div>
                                                                    @enderror
                                                        ...
                                                        <div class="form-group row fv-plugins-icon-container">
                                                            ...
                                                            <div class="col-lg-9 col-xl-9">
                                                                <input
                                                                    ...
                                                                    name="price" type="text" value="{{old('price',$product->price)}}">
                                                                <div class="fv-plugins-message-container">
                                                                    @error('price')
                                                                    <div class="text-danger">{{ $message }}</div>
                                                                    @enderror
                                                        ...
                                                        <div class="form-group row fv-plugins-icon-container">
                                                            ...
                                                            <div class="col-lg-9 col-xl-9">
                                                                <input
                                                                    ...
                                                                    name="sale_price" type="text" value="{{old('sale_price',$product->sale_price)}}">
                                                                <div class="fv-plugins-message-container">
                                                                    @error('sale_price')
                                                                    <div class="text-danger">{{ $message }}</div>
                                                                    @enderror
                                                        ...
                                                        <div class="form-group row fv-plugins-icon-container">
                                                            ...
                                                            <div class="col-lg-9 col-xl-9">
                                                                <input
                                                                    class="form-control form-control-solid form-control-lg @error('sale_price') is-invalid @enderror"
                                                                    name="quantity" type="number" value="{{old('quantity',$product->quantity)}}">
                                                                <div class="fv-plugins-message-container">
                                                                    @error('sale_price')
                                                                    <div class="text-danger">{{ $message }}</div>
                                                                    @enderror
