        ...
        <div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
            ...
            <div class="d-flex align-items-center flex-wrap mr-2">
                ...
                <div class="d-flex align-items-center" id="kt_subheader_search">
                    <span class="text-dark-50 font-weight-bold" id="kt_subheader_total">تعديل الوكيل</span>
                </div>
                <!--end::Search Form-->
            </div>
            <!--end::Info-->
                                ...
                                <div class="row justify-content-center py-8 px-8 py-lg-15 px-lg-10">
                                    <div class="col-xl-12 col-xxl-10">
                                        ...
                                        <form class="form fv-plugins-bootstrap fv-plugins-framework" id="kt_form"
                                              method="post" action="{{route('agents.update',$agent->id)}}"
                                                        ...
                                                        <div class="form-group row fv-plugins-icon-container">
                                                            ...
                                                            <div class="col-lg-9 col-xl-9">
                                                                <input
                                                                    ...
                                                                    name="name" type="text" value="{{old('name',$agent->name)}}" required>
                                                        ...
                                                        <div class="form-group row fv-plugins-icon-container">
                                                            ...
                                                            <div class="col-lg-9 col-xl-9">
                                                                <input
                                                                    ...
                                                                    name="email" type="email" value="{{old('email',$agent->email)}}" required>
                                                        ...
                                                        <div class="form-group row fv-plugins-icon-container">
                                                            ...
                                                            <div class="col-lg-9 col-xl-9">
                                                                <input
                                                                    ...
                                                                    name="phone" type="text" value="{{old('phone',$agent->phone)}}" required>
                                                        ...
                                                        <div class="form-group row fv-plugins-icon-container">
                                                            ...
                                                            <div class="col-lg-9 col-xl-9">
                                                                <input
                                                                    ...
                                                                    name="address" type="text" value="{{old('address',$agent->address)}}" required>
