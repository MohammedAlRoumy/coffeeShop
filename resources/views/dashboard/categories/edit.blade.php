        ...
        <div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
            ...
            <div class="d-flex align-items-center flex-wrap mr-2">
                ...
                <div class="d-flex align-items-center" id="kt_subheader_search">
                    <span class="text-dark-50 font-weight-bold" id="kt_subheader_total">تعديل تصنيف</span>
                </div>
                <!--end::Search Form-->
            </div>
            <!--end::Info-->
                                                ...
                                                <div class="col-xl-9">
                                                    ...
                                                    <div class="my-5 step" data-wizard-type="step-content"
                                                            ...
                                                            <div class="col-lg-9 col-xl-9">
                                                                <div
                                                                    ...
                                                                    <div class="image-input-wrapper"
                                                                         style="background-image:url({{asset('uploads/categories/'.$category->image)}})"></div>
                                                                    <label
                                                        ...
                                                        <div class="form-group row fv-plugins-icon-container">
                                                            <label
                                                                class="col-form-label col-xl-3 col-lg-3">القسم الرئبسي</label>
                                                            <div class="col-xl-9 col-lg-9">
                                                                <select
                                                                    ...
                                                                    @foreach ($categories as $cat)
                                                                        ...
                                                                        <option @if($cat->id == old('parent_id',$category->parent_id)) selected @endif value="{{ $cat->id }}">{{ $category->name }}</option>
                                                        ...
                                                        <!--begin::Group-->
                                                        <div class="form-group row fv-plugins-icon-container">
                                                            <label class="col-xl-3 col-lg-3 col-form-label">اسم التصنيف</label>
                                                            <div class="col-lg-9 col-xl-9">
                                                                <input
                                                                    class="form-control form-control-solid form-control-lg @error('name') is-invalid @enderror"
                                                                    name="name" type="text" value="{{old('name',$category->name)}}">
                                                        ...
                                                        <!--begin::Group-->
                                                        <div class="form-group row fv-plugins-icon-container">
                                                            <label class="col-xl-3 col-lg-3 col-form-label">اسم التصنيف
                                                                في الرابط</label>
                                                            <div class="col-lg-9 col-xl-9">
                                                                <input
