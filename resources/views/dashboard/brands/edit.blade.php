        ...
        <div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
            ...
            <div class="d-flex align-items-center flex-wrap mr-2">
                ...
                <div class="d-flex align-items-center" id="kt_subheader_search">
                    <span class="text-dark-50 font-weight-bold" id="kt_subheader_total">تعديل علامة تجارية</span>
                </div>
                <!--end::Search Form-->
            </div>
            <!--end::Info-->
                                ...
                                <div class="row justify-content-center py-8 px-8 py-lg-15 px-lg-10">
                                    <div class="col-xl-12 col-xxl-10">
                                        ...
                                        <form class="form fv-plugins-bootstrap fv-plugins-framework" id="kt_form"
                                              method="post" action="{{route('brands.update',$brand->id)}}"
                                                            ...
                                                            <div class="col-lg-9 col-xl-9">
                                                                <div
                                                                    ...
                                                                    <div class="image-input-wrapper"
                                                                         style="background-image: url({{asset('uploads/brands/'.old('logo',$brand->logo))}})"></div>
                                                                    <label
                                                        ...
                                                        <div class="form-group row fv-plugins-icon-container">
                                                            ...
                                                            <div class="col-lg-9 col-xl-9">
                                                                <input
                                                                    ...
                                                                    name="slug" type="text" value="{{old('slug',$brand->slug)}}">
                                                                <div class="fv-plugins-message-container">
                                                                    @error('slug')
                                                                    <div class="text-danger">{{ $message }}</div>
                                                                    @enderror
