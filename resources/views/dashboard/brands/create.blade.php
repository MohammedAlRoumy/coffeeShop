    ...
    <div class="subheader py-2 py-lg-4 subheader-solid" id="kt_subheader">
        <div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
            ...
            <div class="d-flex align-items-center flex-wrap mr-2">
                <!--begin::Title-->
                <h5 class="text-dark font-weight-bold mt-2 mb-2 mr-5">العلامات التجارية</h5>
                <!--end::Title-->
                <!--begin::Separator-->
                ...
                <div class="d-flex align-items-center" id="kt_subheader_search">
                    <span class="text-dark-50 font-weight-bold" id="kt_subheader_total">إضافة علامة تجارية</span>
                </div>
                <!--end::Search Form-->
            </div>
            <!--end::Info-->
                                ...
                                <div class="row justify-content-center py-8 px-8 py-lg-15 px-lg-10">
                                    <div class="col-xl-12 col-xxl-10">
                                        ...
                                        <form class="form fv-plugins-bootstrap fv-plugins-framework" id="kt_form"
                                              method="post" action="{{route('brands.store')}}"
                                                ...
                                                <div class="col-xl-9">
                                                    ...
                                                    <div class="my-5 step" data-wizard-type="step-content"
                                                        ...
                                                        <div class="form-group row">
                                                            <label class="col-xl-3 col-lg-3 col-form-label text-left">شعار
                                                            ...
                                                            <div class="col-lg-9 col-xl-9">
                                                                <div
                                                                    ...
                                                                    <div class="image-input-wrapper"
                                                                         style="background-color:#ccc;"></div>
                                                                    <label
                                                                        class="btn btn-xs btn-icon btn-circle btn-white btn-hover-text-primary btn-shadow"
                                                                        data-action="change" data-toggle="tooltip"
                                                                        title="" data-original-title="تغيير الشعار">
                                                                    ...
                                                                    <span
                                                                        ...
                                                                        title="" data-original-title="إلغاء الشعار">
                                                        ...
                                                        <div class="form-group row fv-plugins-icon-container">
                                                            <label class="col-xl-3 col-lg-3 col-form-label">اسم العلامة
                                                                التجارية</label>
                                                            <div class="col-lg-9 col-xl-9">
                                                                <input
...
{{--
                                                        <div class="form-group row fv-plugins-icon-container">
                                                            <label
                                                                class="col-form-label col-xl-3 col-lg-3">الحالة</label>
                                                            <div class="col-xl-9 col-lg-9">
                                                                <select
                                                                    class="form-control form-control-lg form-control-solid @error('status') is-invalid @enderror"
                                                                    name="status">
                                                                    <option>اختر حالة العلامة التجارية</option>
