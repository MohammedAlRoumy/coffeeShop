    ...
    <div class="subheader py-2 py-lg-4 subheader-solid" id="kt_subheader">
        <div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
            ...
            <div class="d-flex align-items-center flex-wrap mr-2">
                <!--begin::Title-->
                <h5 class="text-dark font-weight-bold mt-2 mb-2 mr-5">المشرفون</h5>
                <!--end::Title-->
                <!--begin::Separator-->
                ...
                <div class="d-flex align-items-center" id="kt_subheader_search">
                    <span class="text-dark-50 font-weight-bold" id="kt_subheader_total">تعديل مشرف</span>
                </div>
                <!--end::Search Form-->
            </div>
            <!--end::Info-->
                                                ...
                                                <div class="col-xl-9">
                                                    ...
                                                    <div class="my-5 step" data-wizard-type="step-content"
                                                        ...
                                                        <div class="form-group row fv-plugins-icon-container">
                                                            ...
                                                            <div class="col-lg-9 col-xl-9">
                                                                <input
                                                                    ...
                                                                    name="email" type="email" value="{{old('email',$admin->email)}}" required>
                                                        ...
                                                        <div class="form-group row fv-plugins-icon-container">
                                                            ...
                                                            <div class="col-lg-9 col-xl-9">
                                                                <input
                                                                    ...
                                                                    name="phone" type="text" value="{{old('phone',$admin->phone)}}" required>
                                                        ...
                                                        <div class="form-group row fv-plugins-icon-container">
                                                            ...
                                                            <div class="col-lg-9 col-xl-9">
                                                                <input
                                                                    ...
                                                                    name="address" type="text" value="{{old('address',$admin->address)}}" required>
                                                        ...
                                                        <div class="form-group row">
                                                            ...
                                                            <div class="col-9 col-form-label">
                                                                <select
                                                                    class="form-control select2 @error('roles_name') is-invalid @enderror" id="kt_select2_3" name="roles_name[]" multiple=""
