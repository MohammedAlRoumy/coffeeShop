        ...
        <div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
            ...
            <div class="d-flex align-items-center flex-wrap mr-2">
                ...
                <div class="d-flex align-items-center" id="kt_subheader_search">
                    <span class="text-dark-50 font-weight-bold" id="kt_subheader_total">عرض مشرف</span>
                </div>
                <!--end::Search Form-->
            </div>
            <!--end::Info-->
                                                ...
                                                <div class="my-5 step" data-wizard-type="step-content"
                                                    ...
                                                    <div class="form-group row fv-plugins-icon-container">
                                                        ...
                                                        <div class="col-lg-9 col-xl-9">
                                                            <input
                                                                ...
                                                                name="email" type="email" value="{{$admin->email}}"
                                                                readonly>
                                                    ...
                                                    <div class="form-group row fv-plugins-icon-container">
                                                        ...
                                                        <div class="col-lg-9 col-xl-9">
                                                            <input
                                                                class="form-control form-control-solid form-control-lg "
                                                                name="phone" type="text" value="{{$admin->address}}"
                                                                readonly>
                                                    ...
                                                    <div class="form-group row fv-plugins-icon-container">
                                                        ...
                                                        <div class="col-xl-9 col-lg-9">
                                                            <select
                                                                class="form-control form-control-lg form-control-solid "
                                                                name="roles_name[]" disabled>
                                                                @foreach($adminRole as $role)
                                                                    <option
                                                                        value="{{ $role->name }}" selected>{{ $role->name }}</option>
                                                                @endforeach
                                                            </select>
                                                            <div class="fv-plugins-message-container"></div>
                                                        </div>
                                                            ...
                                                            <div
                                                                ...
                                                                <label class="radio radio-success">
                                                                    <input type="radio" name="status" value="1"
                                                                           {{$admin->status =='1'?'checked':''}} disabled/>
                                                                    <span></span>
                                                                    مفعل
                                                                </label>
                                                                <label class="radio radio-success">
                                                                    <input type="radio" name="status" value="0"
                                                                           {{$admin->status =='0'?'checked':''}} disabled/>
                                                                    <span></span>
                                                                    غير مفعل
                                                                </label>
                                                            </div>
