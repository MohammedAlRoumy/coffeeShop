             ...
             <div class="row">
                 <div class="col-3">
                     @if (config('settings.site_logo') != null)
                         <img src="{{ asset('uploads/settings/'.config('settings.site_logo')) }}" id="logoImg" style="width: 80px; height: auto;">
                     @else
             ...
             <div class="row mt-4">
                 <div class="col-3">
                     @if (config('settings.site_favicon') != null)
                         <img src="{{ asset('uploads/settings/'.config('settings.site_favicon')) }}" id="faviconImg" style="width: 80px; height: auto;">
                     @else
                 ...
                 <div class="col-9">
                     <div class="form-group">
                         <label class="control-label">أيقونة المتجر</label>
